...
- 📂 **`Java-Lab-Report/`**: Detailed solutions, source code, and documentation for university lab assignments and experiments.
...
3. **Compile the Java file** (replace `FileName` with your actual `.java` file name):
   ```bash
   javac FileName.java
   ```
